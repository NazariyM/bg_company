...
var _cTabs = __webpack_require__(8);
...
var _contactMaps = __webpack_require__(16);

var _initDot = __webpack_require__(17);

var _initDot2 = _interopRequireDefault(_initDot);

var _objectFitImages = __webpack_require__(19);
...
var Flatpickr = __webpack_require__(24);
var Russian = __webpack_require__(25).ru;
...
var _vintagePopup = __webpack_require__(7);
...
function initTimeline() {
  ...
  var $timelineTrack = $timeline.find('.timeline__track');
  var $timelineItem = $timelineTrack.children();
  ...
  var $timelineBtn = $timeline.find('.timeline__range-btn');
  var element = document.getElementById('timeline-range-btn');
  var rangeWidth = $('.timeline__range').outerWidth();
  var btnWidth = $('.timeline__range-btn').outerWidth();
...
exports.initContactMaps = initContactMaps;
function initContactMaps() {

  var $mapsBlock = $('.contact-maps');
  if (!$mapsBlock.length) return;

  var samara = [53.18961457121754, 50.11800699999997];
  var togliatti = [53.515948070985026, 49.2798334999999];
  var ijevsk = [56.86817706781662, 53.27362649999997];

  ymaps.ready(init);

  function init() {
    var contactMap1 = new ymaps.Map('contact-map-1', {
      center: samara,
      zoom: 15,
      controls: []
    });
    var samaraBalloon = new ymaps.Placemark(samara, {
      balloonContent: 'Самара, ул. Красноармейская, 72'
    });
    contactMap1.geoObjects.add(samaraBalloon);

    var contactMap2 = new ymaps.Map('contact-map-2', {
      center: togliatti,
      zoom: 16,
      controls: []
    });
    var togliattiBalloon = new ymaps.Placemark(togliatti, {
      balloonContent: 'Тольятти, ул. Юбилейная, 31И оф. 301'
    });
    contactMap2.geoObjects.add(togliattiBalloon);

    var contactMap3 = new ymaps.Map('contact-map-3', {
      center: ijevsk,
      zoom: 16,
      controls: []
    });
    var ijevskBalloon = new ymaps.Placemark(ijevsk, {
