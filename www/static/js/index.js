...
var _initTimer = __webpack_require__(9);

var _initDot = __webpack_require__(10);
...
var Timer = exports.Timer = function () {
  function Timer(el) {
    ...
    this.$el = $(el);
    this.$year = this.$el.find('.info__time-digit_year');
    this.$month = this.$el.find('.info__time-digit_month');
    this.$day = this.$el.find('.info__time-digit_day');
    this.init();
  }
...
// export const InfoTimer = new Timer('.js-info-timer');
